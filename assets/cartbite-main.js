if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BBMoB02LDC6qZF3Nlo5mx3vqkou1hhgsx1WYrR-aJnpMVsOSoWgy2sAlEJywYk9gIXbbbgA5agibj_pebvicSbA",
    clientId: "3N5BUD5CB5WVLNBZYE3J2F3H",
    ...
    stockFulFilledPushCampaign: {
      isActive: false,
      uniqueId: 'NBWCSGNFCZD5LDVNJFQ9T5MS'
    },
    stockFulFilledEmailCampaign: {
      isActive: false,
      uniqueId: '8KSJ6VQLFV15DK7TFR1KYFHT'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: 'L1QFQPRKMMBGSAAIVUT9AJNK'
    },
    priceDropPushCampaign: {
      isActive: false,
      uniqueId: 'RSPSU3L2X5TUQUS2L7ABSA9G',
    },
    priceDropEmailCampaign: {
      isActive: false,
      uniqueId: 'MM5PSSPKKS97RPVXPF6GRCAS',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: '266W87S6QZGG5P25BTIZH91Q',
    },
    stockWidget: {
      ...
      backgroundColor: "#8ba473",
      textColor: "#ffffff",
      subscriptionText: "Benachrichtige mich wenn wieder verfügbar ",
      subscribedText: "Wir benachrichtigen dich sobald diese Farbe wieder verfügbar ist :)",
      modalHtml: `<html>
<head>
...
<div class="modal" v-cloak id="el">
  <div class="modal-container">
    ...
    <h3 class="modal-title">Alles klar, wir benachrichtigen dich sobald diese Farbe wieder verfügbar ist :)</h3>
    ...
    <template v-if="selectedChannel==='email'">
      ...
      <small style="color: red" v-if="!isEmailValid">Bitte gültige Email Adresse angeben</small>
    </template>
    ...
    <div v-if="dataEntered" class="gw-success-message alert alert-success complete"> Deine Benachrichtigung wurde registriert
      <a href="#"
         class="action-close"
         @click.p.prevent="closeModal">Schliessen</a>
    </div>
    ...
    <div class="marketing-container" v-if="shopifyMailingListEnabled">
      ...
      <label class="marketing-container-label" for="accepts_marketing">Interessiert an unserem Newsletter?</label>
    </div>
    <p class="privacy-text">Wir respektieren deine Privatsphäre und geben deine E-Mail-Adresse an niemanden weiter.</p>
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        heading: "heading",
        subheading: "",
        notifyButtonTitle: "Benachrichtige mich",
        privacyText: "Wir respektieren deine Privatsphäre und geben deine E-Mail-Adresse an niemanden weiter.",
        emailWorkflowUniqueId: "8KSJ6VQLFV15DK7TFR1KYFHT",
        smsWorkflowUniqueId: "L1QFQPRKMMBGSAAIVUT9AJNK",
        successText: "Deine Benachrichtigung wurde registriert",
        successCloseText: "Schliessen",
        optInMarketingText: "Interessiert an unserem Newsletter?",
        email: "",
        phoneNumber: '',
        ...
        emailPlaceholder: 'Email Addresse',
...
`,
    ...
    customJs: `let insertAfterEle=document.querySelector(".product-info__buy-buttons");
